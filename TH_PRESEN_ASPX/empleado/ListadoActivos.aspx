<%@ Page Title="Listado Empleados" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="ListadoActivos.aspx.cs" Inherits="TH_PRESEN_ASPX_GC.empleado.ListadoActivos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/empleado/ListadoActivo.js"></script>
</asp:Content>
                        ...
                        <asp:GridView ID="grvListadoGeneral" runat="server" CssClass="table table-hover table-striped" GridLines="None"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <%--                                  <asp:Button ID="AddButton" runat="server" CssClass="btn btn-success glyphicon glyphicon-search"
